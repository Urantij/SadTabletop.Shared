...
// upd какого хуя сверху написано что передумал, а система осталась?
// похуй мне на эти ветки зависимостей, эта ивентовая параша не складывается как надо.
// синхронизация через ивенты работает, если все модификации объектов работают через ивенты.
// но у меня только добавлеие убирание объектов. значит порядок сообщений будет кривой и кал.
// а делать ивенты на всё заебусь
